...
public class Account implements Serializable
{
    ...
    private Account(final String id, final String openStatus, final String displayName, final String nickName, final String accountNumber, final Boolean owner)
    {
        this.id = id;
					...
					final Object accountNumberObj, final Object ownerObj) throws UnhandledErrorException
    {
        ...
        final String accountNumber = getStringValue("accountNumber", accountNumberObj, true);
        final Boolean owner = getBooleanValue("isOwned", ownerObj, true);
